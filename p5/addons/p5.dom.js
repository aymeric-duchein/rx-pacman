...
(function(root, factory) {
   ...
   * properties of style. If no arguments given returns the column and y position
   * of the element in an object.
   *
   * @method position
   * @returns {Object} the column and y position of the element in an object
   * @example
   * <div><code class='norender'>
   * function setup() {
  ...
  /**
   * @method position
   * @param  {Number} [column] column-position relative to upper left of window
